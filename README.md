...
- **MTP speculative decoding scaffolding** — Gemma4 assistant drafter loader, alias-safe projection helpers, verifier plan/forward scaffolding, model-aware verifier result validation, acceptance accounting consistency checks, and staged KV commit/rollback (end-to-end verifier/drafter generation wiring pending)
