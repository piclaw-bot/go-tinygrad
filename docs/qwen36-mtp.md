...
- [x] map tensor prefix (`model.language_model.` if present) and provide a candidate tensor-source wrapper plus directory-level safetensors base-layer loader for loader integration;
