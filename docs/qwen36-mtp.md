...
4. **Native MTP head**
   ...
   - implement K=1 greedy draft step (CPU skeleton now covers preprojection plus a single-token full-attention/MLP MTP block and final MTP norm + main LM-head logits/argmax; RoPE/history KV integration remain next);
