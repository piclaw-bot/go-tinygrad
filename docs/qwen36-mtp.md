...
4. **Native MTP head**
   ...
   - implement K=1 greedy draft step (CPU skeleton now covers preprojection plus a single-token full-attention/MLP MTP block; RoPE/history KV/LM-head integration remain next);
