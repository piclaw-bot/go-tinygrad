...
test:
	go test -count=1 -timeout=120s ./loader/safetensors/... ./model/... ./models/bert/... ./backends/simd/... ./tensor/...
...
smoke:
	...
	go vet ./...
	@echo "=== unit tests ==="
	go test -count=1 -timeout=60s ./loader/safetensors/... ./backends/simd/... ./tensor/...
	@echo "=== ok ==="
