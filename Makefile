...
test:
	go test -count=1 -timeout=120s ./loader/... ./model/... ./models/bert/... ./backends/placement/... ./backends/simd/... ./runtime/... ./tensor/...
...
smoke:
	...
	go vet ./...
	@echo "=== unit tests ==="
	go test -count=1 -timeout=60s ./loader/... ./backends/placement/... ./backends/simd/... ./runtime/... ./tensor/...
	@echo "=== ok ==="
