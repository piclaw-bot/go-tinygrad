...
test:
	go test -count=1 -timeout=120s ./loader/... ./model/... ./models/bert/... ./backends/cuda/ptx/... ./backends/placement/... ./backends/simd/... ./backends/vulkan/... ./runtime/... ./tensor/...
...
smoke:
	...
	go vet ./...
	@echo "=== unit tests ==="
	go test -count=1 -timeout=60s ./loader/... ./backends/cuda/ptx/... ./backends/placement/... ./backends/simd/... ./backends/vulkan/... ./runtime/... ./tensor/...
	@echo "=== ok ==="
