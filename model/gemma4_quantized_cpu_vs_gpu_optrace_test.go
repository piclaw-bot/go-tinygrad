...
func TestGemma4QuantizedCPUvsGPUOpTrace(t *testing.T) {
	if os.Getenv("GEMMA4_TRACE_TEST") == "" {
		t.Skip("set GEMMA4_TRACE_TEST=1 for Gemma4 quantized CPU vs GPU op trace")
	}
	dir := gemma4Path()
	...
	targetLayers := map[int]bool{14: true, 15: true}
